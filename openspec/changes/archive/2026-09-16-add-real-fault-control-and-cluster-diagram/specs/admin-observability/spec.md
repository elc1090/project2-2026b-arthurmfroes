...
**Reason**: A marca cooperativa no banco compartilhado mantém os processos vivos, limita a demonstração ao desenvolvimento e permite que o nó conheça previamente a falha. Ela não representa a perda inesperada exigida.

**Migration**: Substituir os controles pelo atuador descrito em `infrastructure-fault-control`; desenvolvimento e Railway passam a executar o mesmo contrato de falha externa e recuperação.
